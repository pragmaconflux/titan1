...
class PerformanceMetrics:
    ...
    top_functions: Dict[str, float] = field(default_factory=dict)  # Top 10 slowest functions
...
class PerformanceProfiler:
    ...
    def _end_profiling(self):
        ...
        self.metrics.memory_average = sum(self.memory_samples) / len(self.memory_samples)
...
class BenchmarkSuite:
    ...
    def benchmark_decoding(self, engine, test_data: bytes, name: str, 
                          enable_cprofile: bool = False) -> PerformanceMetrics:
    ...
    def benchmark_multiple_sizes(self, engine, base_data: bytes, sizes: List[int],
                                name_prefix: str = "size_") -> Dict[int, PerformanceMetrics]:
    ...
    def benchmark_recursion_depth(self, engine, create_nested_data: Callable,
                                 max_depth: int = 5) -> Dict[int, PerformanceMetrics]:
    ...
    def print_results(self, name: str = None):
        ...
        print("\n" + "="*100)
        print(f"{'Benchmark':<40} {'Time (s)':<12} {'Nodes':<10} {'Throughput':<15} {'Mem Peak':<12}")
        print("-"*100)
        
        for bench_name, metrics in results.items():
            print(f"{bench_name:<40} {metrics.execution_time:<12.4f} "
