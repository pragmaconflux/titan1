...
def test_get_top_risky_nodes():
    report = {
        "nodes": [
            {"id": 0, "depth": 0, "entropy": 3.0, "decode_score": 0.1, "content_preview": "hello", "method": "ANALYZE"},
            {"id": 1, "depth": 2, "entropy": 8.5, "decode_score": 0.9, "content_preview": "MZ binary", "method": "Base64"},
            {"id": 2, "depth": 1, "entropy": 5.0, "decode_score": 0.3, "content_preview": "data", "method": "Gzip"},
        ]
    }
